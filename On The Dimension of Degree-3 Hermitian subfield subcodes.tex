...
holds for all $u,v$. Since $\langle .,. \rangle$ is non-trivial, unitary transformations are invertible. Moreover, for all $u,v$ one has
\begin{align*}
...
In this way, the unitary linear maps $B$ and $\Delta$ induce automorphisms of the function field, which we denote by $B^*$ and $\Delta^*$.
