...
\begin{proposition} \label{prop:sub}
	$G_1$ be a positive divisor of the Hermitian curve $\mathscr{H}_q$, and $D=Q_1+\cdots+Q_n$ the sum of $\mathbb{F}_{q^2}$-rational places such that $\Supp(G)\cap \Supp(D)=\emptyset$. Assume that $\deg G_1 \leq (n+\g-1)/q$. Then 
	\[
